<div class="col-md-4 col-">
    <div class="list-group">
        <a href="/seller/profile/create" class="list-group-item list-group-item-action">
            <svg style="width: 15px;margin-right: 5px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            Create Food</a>
        <a href="/seller/profile/reports" class="list-group-item list-group-item-action">
            <svg style="width: 15px;margin-right: 5px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                <path
        ...
        <a href="/seller/profile/comments" class="list-group-item list-group-item-action">
            <svg style="width: 15px;margin-right: 5px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <a href="/seller/profile/show/{{$user->restaurant->id}}" class="list-group-item list-group-item-action">
            <svg style="width: 15px;margin-right: 5px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                <path
        ...
        <a href="/seller/profile/editProfile/{{$user->restaurant->id}}" class="list-group-item list-group-item-action">
            <svg style="width: 15px;margin-right: 5px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                <path
