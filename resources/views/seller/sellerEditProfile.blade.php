    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8 col- text-center mt-1.5">
                <form id="form_id" method="post" action="/seller/profile/editProfile/{{$resaurant->id}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group mt-2">
                        <div class="text-start">
                            <label for="name">Restaurant name</label>
                        </div>
                        <input type="text" value="{{$resaurant->name}}" class="form-control mb-3" name="name" id="name" placeholder="Enter restaurant name">
                        <div class="text-start">
                            <label for="phone">Phone</label>
                        </div><input value="{{$resaurant->phone}}" type="text" class="form-control mb-3" name="phone" id="phone" placeholder="Enter restaurant phone">
                        <div class="text-start">
                            <label for="address">Address</label>
                        </div><input type="text" value="{{$resaurant->address}}" class="form-control mb-3" name="address" id="address" placeholder="Enter restaurant phone">
                        ...
                        <script type="text/javascript">
                            ...
                            $("#form_id").submit(function(e){
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "http://localhost:8000/seller/profile/editProfile/{{$resaurant->id}}",
                                    data: {
